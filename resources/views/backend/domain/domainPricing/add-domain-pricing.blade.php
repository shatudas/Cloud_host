          ...
          @csrf
           ...
           <div class="form-row">
            ...
            <div class="form-group col-md-6">
             ...
             <input type="text" name="name" class="form-control" placeholder="Enter TLD name ">
             <font style="color:red">{{ ($errors->has('name'))?($errors->first('name')):'' }}</font>
            </div>

            <div class="form-group col-md-6">
             <label for="price"> New Price <span style="color:red;">*</span></label>
             <input type="number" name="price" class="form-control" placeholder="Enter new price">
            ...
            <div class="form-group col-md-6">
             ...
             <input type="number" name="price_duration" class="form-control" placeholder="Enter duration">
            ...
            <div class="form-group col-md-6">
             ...
             <input type="number" name="transferprice" class="form-control" placeholder="Enter new transfer price">
            ...
            <div class="form-group col-md-6">
             ...
             <input type="number" name="transfer_duration" class="form-control" placeholder="Enter duration">
            ...
            <div class="form-group col-md-6">
             ...
             <input type="number" name="renewalprice" class="form-control" placeholder="Enter new renewal price">
            ...
            <div class="form-group col-md-6">
             ...
             <input type="number" name="renewal_duration" class="form-control" placeholder="Enter renewal duration">
            ...
            <div class="form-group col-md-6">
             ...
             <input type="number" name="graceprice" class="form-control" placeholder="Enter new renewal price">
            ...
            <div class="form-group col-md-6">
             ...
             <input type="number" name="grace_duration" class="form-control" placeholder="Enter grace duration">
