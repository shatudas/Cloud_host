          ...
          @csrf
           ...
           <div class="form-row">
            ...
            <div class="form-group col-md-12">
             ...
             <textarea type="text" name="history"class="form-control" rows="4"></textarea>
