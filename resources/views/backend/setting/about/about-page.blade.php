      ...
      <div class="row justify-content-center">
       <div class="col-8">
        <div class="card">
         ...
         <div class="card-body">
          <form method="POST" action="{{ route('about.update',$editData->id) }}" enctype="multipart/form-data" id="myForm">
          @csrf
           ...
           <div class="form-row">
            ...
            <div class="form-group col-md-12">
             <label for="title"> About Discriptsion </label>
            ...
            <div class="form-group col-md-8" align="justify-content-center">
             <img id="showImage" src="{{ !empty($editData->image)?url('upload/about_image/'.$editData->image):url('upload/No-image.jpg') }}" style="width:150px; height:150px; margin-top:30px; border:1px solid #ccc;" >
            </div>
