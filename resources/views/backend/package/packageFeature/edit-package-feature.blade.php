       ...
       <div class="col-8">
        <div class="card">
         ...
         <div class="card-header">
          <h3> Edit Package Feature
           <a href="{{ route('package.feature.view') }}" class=" btn btn-primary btn-sm float-right"><i class="fa fa-list"></i> Package Feature List </a>
          </h3>
         </div>
         <div class="card-body">
          <form method="POST" action="{{ route('package.feature.update',$editdata->id) }}" enctype="multipart/form-data" id="myForm">
          @csrf
           ...
           <div class="form-row">
            ...
            <div class="form-group col-md-4 " align="center">
             <img id="showImage" src="{{ !empty($editdata->image)?url('upload/Package_Feature/'.$editdata->image):url('upload/No-image.jpg') }}" style="width:70%; height:130px; border:1px solid #ccc;">
            </div>
