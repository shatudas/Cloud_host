...
<footer id="footer">
   ...
   <div class="row">
    ...
    <div class="col-lg-3 col-md-6 footer-contact">
     ...
     <p> {{ $setting->address }}<br>
      <strong>Phone: </strong>
      <a href="tel:{{ $setting->phone }}" class="text-white"><i class="fa fa-phone"></i> {{ $setting->phone }}</a><br>
      <strong>Email: </strong>
      <a href="mailto:{{ $setting->email }}" class="text-white"><i class="fa fa-envelope-open"></i>{{ $setting->email }}</a><br>
     </p>
    </div>
 ...
 <div class="container footer-bottom clearfix">
  <div class="copyright">
   <center> &copy {{ Date('Y') }} Copyright <strong> <span><a href="#">Web Host</a> </span> </strong>. All Rights Reserved </center>
  </div>
 </div>
